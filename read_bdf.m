...
% Example:
% 
%     >> filename = 'C:\eConScan_import1.0\sample_data\data.bdf';
%     >> hdr = read_bdf(filename);
%     >> hdr = read_bdf(filename,hdr, begsample, endsample, chanindx);
% 
% Parts based on read_bdf.m of FieldTrip, see http://www.fieldtriptoolbox.org
...
if nargin==1
  ...
  if fid<0
    fprintf(2,'Error LOADEDF: File not found\n');
    return;
  end;
